...
def inter2bundles (dir_fib1,dir_fib2,outdir, d_th):
    ...
    for b1 in labelsb1:
        for b2 in labelsb2:
            ...
            sp.run(['./dinter/fiberDistanceMax2bun', dir_fib1, dir_fib2, outfile])
...
#dir_fib1="/media/liset/Disco Local/Biblioteca/Utils/data/Inter2bundles/atlas_AR_LEFT.bundles"
#dir_fib2="/media/liset/Disco Local/Biblioteca/Utils/data/Inter2bundles/S100206.bundles"
...
# de distancia (se puede borrar, pero es mejor dejarla disponible)
